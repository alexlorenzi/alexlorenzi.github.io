...
},{"./bundle-url":"../node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"styles/site.scss":[function(require,module,exports) {
...
var _cv = _interopRequireDefault(require("./assets/cv.md"));

require("./styles/site.scss");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var resume_content = document.getElementById("resume"); // Link scroll to resume

document.querySelector("#link__resume").addEventListener("click", function (e) {
  e.preventDefault();
  resume_content.scrollIntoView();
}); // Render Resume

var md = new _remarkable.Remarkable("default", {
  html: true
});
resume_content.querySelector(".content").innerHTML = md.render(_cv.default);
},{"remarkable":"../node_modules/remarkable/dist/esm/index.browser.js","./assets/cv.md":"assets/cv.md","./styles/site.scss":"styles/site.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
var b=require("../node_modules/parcel-bundler/src/builtins/bundle-loader.js");b.register("html",require("../node_modules/parcel-bundler/src/builtins/loaders/browser/html-loader.js"));b.load([["cv.ccc81d3c.html","assets/cv.md"]]).then(function(){require("index.js");});
